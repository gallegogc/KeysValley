...
@Component({
  selector: 'app-juego-sin-stock-mov',
  templateUrl: './juego-sin-stock-mov.component.html',
  styleUrls: ['./juego-sin-stock-mov.component.css']
})
export class JuegoSinStockMovComponent implements OnInit {
